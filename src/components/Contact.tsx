      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Первое занятие — бесплатная диагностика. Напишите мне, расскажите о целях,
              и мы вместе выстроим путь к результату.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажите о целях и уровне ученика..."
                  required
                />
              </div>
              <button
