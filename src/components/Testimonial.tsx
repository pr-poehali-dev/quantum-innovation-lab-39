  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Благодаря занятиям с Еленой Владимировной мой сын сдал ЕГЭ на 89 баллов. Она не просто объясняет правила —
          она учит думать и не бояться трудных заданий. Это настоящий педагог с большой буквы.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Марина Соколова</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Мама ученика 11 класса</p>
        </div>
      </div>
    </section>
  )
