...
const steps = [
  {
    ...
    title: "Знакомство",
    description:
      "Начинаю с понимания ученика: его уровня, целей и того, что мешает двигаться вперёд. Первое занятие — всегда диагностика.",
  },
  {
    number: "02",
    title: "Программа",
    description:
      "Составляю индивидуальный план занятий. Никаких шаблонов — только то, что нужно именно этому ученику в данный момент.",
  },
  {
    number: "03",
    title: "Практика",
    description:
      "Объясняю, тренируемся, разбираем ошибки. Каждое занятие — шаг вперёд с опорой на предыдущий материал.",
  },
  {
    number: "04",
    title: "Результат",
    description:
      "Отслеживаю прогресс и корректирую программу. Цель не просто сдать экзамен — а обрести уверенность в себе.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> к знаниям</span>
              </h2>
              <p
              ...
              >
                Хорошие результаты не бывают случайными. Они рождаются из системной работы,
                уважения к темпу ученика и веры в то, что каждый способен на большее.
              </p>
            </div>
          </div>
