...
const services = [
  {
    title: "Русский язык",
    description: "Углублённое изучение грамматики, орфографии и стилистики. Подготовка к ОГЭ и ЕГЭ с гарантированным результатом.",
    icon: (
  ...
  {
    title: "Литература",
    description: "Анализ художественных текстов, развитие читательского мышления и умения выражать мысли в сочинениях.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Персональная программа под цели и темп каждого ученика. Занятия очно или онлайн в удобное время.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Системная подготовка к ОГЭ, ЕГЭ и олимпиадам. Разбор заданий, работа над ошибками, тренировочные тесты.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
